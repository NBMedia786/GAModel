...
import { Search, Sparkles, AlertCircle, Clock, Send, User, Edit2, Trash2, Check, X, MoreVertical } from "lucide-react";
        ...
        <div className="p-4 space-y-3">
          ...
          {comments
            ...
            .map((comment) => {
              ...
              // ✏️ EDITING STATE (For both AI and Human)
              if (isEditing) {
                return (
                  <div key={comment.id} className="rounded-lg p-3 bg-muted border-l-2 border-primary">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={(e) => handleDeleteClick(comment.id, e)} className="text-destructive focus:text-destructive">
                      ...
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <span
                            ...
                            style={{ color: getUserColor(comment.user) }}
                          >
                            {comment.user}
                          </span>
